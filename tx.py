...
class Tx:
    ...
    def fee(self):
        ...
        for tx_in in self.tx_ins:
            input_sum += tx_in.value(False)
        for tx_out in self.tx_outs:
            output_sum += tx_out.amount
        return input_sum - output_sum

    @classmethod
    def parse(cls, s, testnet):
...
class TxIn:
    ...
    def parse(cls, s):
        ...
        sequece = little_endian_to_int(s.read(4))
        return cls(prev_tx, prev_index, script_sig, sequece)
